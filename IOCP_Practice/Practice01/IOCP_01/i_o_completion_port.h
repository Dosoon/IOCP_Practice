...
public:
	...
	/// <summary>
	/// 서버 주소 정보를 리슨 소켓에 Bind하고 Listen 처리 <br/>
	/// 백로그 큐 사이즈를 지정하지 않으면 5로 설정된다.
	/// </summary>
	...
	/// </summary>
	virtual void OnRecvMsg(ClientInfo* p_client_info, DWORD io_size) = 0;

	/// <summary>
	/// Send I/O 작업이 끝난 후 호출된다.
	/// </summary>
	virtual void OnSendMsg(ClientInfo* p_client_info, DWORD io_size) = 0;
